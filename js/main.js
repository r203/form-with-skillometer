...
/* harmony import */ var _skillometer__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./skillometer */ "./src/js/skillometer.js");
/* harmony import */ var _skillometer__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_skillometer__WEBPACK_IMPORTED_MODULE_2__);
...
var rangeShow = document.querySelector(".form__number");
var rangeClock = document.querySelector('.skillometer__clock');
var skill = document.querySelectorAll('.skills__checkbox');
...
function rangeChange() {
  ...
  percentSkill = Math.round(summ * 100 / skill.length);
  rangeClock.style.transform = 'rotate(' + (-90 + percentSkill * 180 / 100) + 'deg)';
  rangeShow.value = percentSkill + '%';
}

form.addEventListener('change', rangeChange);
